...
function renderMd(raw){
  ...
  s=s.replace(/((?:^\|.+\|\n?)+)/gm,block=>{
    ...
    const _protectPipes=r=>{let prev;do{prev=r;r=r.replace(/([([\x7b][^)\]\x7d]*)[|]([^)\]\x7d]*[)\]\x7d])/g,(_,a,b)=>a+'\x00PIPE\x00'+b);r=r.replace(/(`[^`]*)[|]([^`]*`)/g,(_,a,b)=>a+'\x00PIPE\x00'+b);}while(r!==prev);return r;};
